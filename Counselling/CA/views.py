...
def send_notification(request):
    if request.method == 'POST':
        ...
        account_sid = 'AC6a6dda3dc4872983266f26056ddd9d21'
        auth_token = '8e6543b458f7e854e3f9788561e87fe9'
        twilio_phone_number = '+12184527286'
        if not (account_sid and auth_token and twilio_phone_number):
            return JsonResponse({'success': False, 'error': 'Twilio credentials not configured'})
